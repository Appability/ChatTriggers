...
class KeyBind {
    ...
    fun registerKeyPress(method: Any) = run {
        onKeyPress = OnRegularTrigger(method, TriggerType.Other, EngineInfo.getLoader())
        onKeyPress
    }

    fun registerKeyRelease(method: Any) = run {
        onKeyRelease = OnRegularTrigger(method, TriggerType.Other, EngineInfo.getLoader())
        onKeyRelease
    }

    fun registerKeyDown(method: Any) = run {
        onKeyDown = OnRegularTrigger(method, TriggerType.Other, EngineInfo.getLoader())
        onKeyDown
    }
